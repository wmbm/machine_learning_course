...
h = a_3; % Equivalent to hypothesis

% Recode labels as vectors
I = eye(num_labels); % Diagonal matrix size of labels
Y = zeros(m, num_labels); % Number of pixels /  number of labels
for i=1:m % Loop through pixels
  Y(i, :)= I(y(i), :);
end
...
sigma_3 = a_3 - Y;
a = sigma_3*Theta2;
sigma_2 = a(:,2:end).*sigmoidGradient(z_2);
